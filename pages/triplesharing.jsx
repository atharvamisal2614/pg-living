...
const triplesharing = () => {
  const roomImage = "/pgimages/three-sharing.jpg";
  const miniImages = [
    "/pgimages/three-sharing.jpg",
    "/pgimages/three-sharing-studytable.jpg",
    "/pgimages/three-sharing-1.jpg"
  ];
    ...
    <div className="bg-gradient-to-t from-pastelAliceBlue to-white flex justify-center items-start p-5">
      <div className="flex flex-col md:flex-row w-full max-w-7xl">
        <div className="w-full md:w-3/5 mb-5 md:mb-0">
          <h1 className="text-5xl text-gray-700 mb-5">Triple Bed Sharing</h1>
        ...
        <div className="w-full md:w-2/5 p-5">
          ...
          <p className="mt-2">Starting From: <span className="font-semibold"> ₹6,999 </span>(Meal Included)</p>
          <p className="mt-2">Max Check-in Time: <span className="font-semibold">9:30 PM</span></p>
          <p className="mt-2">Security Deposit: <span className="font-semibold">₹12,000</span> (Refundable)</p>
