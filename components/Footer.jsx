...
function Footer(){
    return(
        <footer className="text-gray-100 body-font bg-secondaryPurple">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p className="mt-2 text-sm text-gray-100">Nest away..... live your dream</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-100 hover:text-gray-800">First Link</a>
          </li>
          <li>
            <a className="text-gray-100 hover:text-gray-800">Second Link</a>
          </li>
          <li>
            <a className="text-gray-100 hover:text-gray-800">Third Link</a>
          </li>
          <li>
            <a className="text-gray-100 hover:text-gray-800">Fourth Link</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
  ...
  <div className="bg-secondaryPurple">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-100 text-sm text-center sm:text-left">© 2024 Nestaway
